...
1. Configure the `upstream` repo (`git remote add upstream git://github.com/OpenMAVN/MAVN.Service.CustomerManagement.git`)
...
1. Send a descriptive [pull request](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/about-pull-requests) on GitHub.
   - Make sure the pull request is **from** the branch on your fork **to** the `OpenMAVN/MAVN.Service.CustomerManagement` `master`.
